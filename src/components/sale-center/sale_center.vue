  ...
  <div style="text-align:left">
    ...
    <el-submenu index="4" class="el-submenu">
      ...
      <el-menu-item index="4-1">
        <router-link to="/saleCenter/statistics/sIncome" class="router-link" style="margin-left: 7px">收入统计</router-link>
      </el-menu-item>
      <el-menu-item index="4-2">
        <router-link to="/saleCenter/statistics/sRegister" class="router-link" style="margin-left: 7px">注册统计</router-link>
      </el-menu-item>
    </el-submenu>
